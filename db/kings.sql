...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 27, 2022 at 02:27 PM
...
INSERT INTO `customer_order` (`code`, `product_name`, `quantity`, `size`, `price`, `phone`, `email`, `user_name`, `brand`, `fabric`, `category`) VALUES
('pav1', 'Cotton Shirt', 1, 's', 5000, 2147483647, 'bijal@gmail.com', 'Bijal', '', '', '');
...
INSERT INTO `discountproduct` (`code`, `name`, `brand`, `fabric`, `size`, `price`, `image`, `fashion`, `category`, `discount`) VALUES
('1e07', 'Russia Tshirt', 'Gorkhali', 'Cotton', 'S,M,L,XL', '700', '1556745554.jpg', 'men', 't-shirt', 40),
('mwid', 'Hoodie', 'Jack and Jones', 'Cotton', 'S,M,L,XL', '1200', '1556744047.jpg', 'men', 'jacket', 40);
...
INSERT INTO `history` (`code`, `product_name`, `quantity`, `size`, `price`, `phone`, `email`, `user_name`, `brand`, `fabric`, `category`) VALUES
...
('1e07', '', 1, 's', 0, 2147483647, 'bijal@gmail.com', 'Bijal', '', '', ''),
('sw0g', 'Casual Jacket', 1, 's', 3300, 2147483647, 'bijal@gmail.com', 'Bijal', '', '', ''),
('rzuk', 'Boxer Pant', 1, 'l', 1000, 2147483647, 'bijal@gmail.com', 'Bijal', '', '', ''),
('1e07', '', 1, 'm', 0, 2147483647, 'bijal@gmail.com', 'Bijal', '', '', ''),
('1e07', '', 1, 'l', 0, 2147483647, 'bijal@gmail.com', 'Bijal', '', '', ''),
('1e07', '', 1, 's', 0, 2147483647, 'bijal@gmail.com', 'Bijal', '', '', ''),
('1e07', 'Russia Tshirt', 1, 's', 420, 2147483647, 'bijal@gmail.com', 'Bijal', '', '', ''),
('s68u', 'Jogger', 1, 'l', 5000, 2147483647, 'bijal@gmail.com', 'Bijal', '', '', ''),
('ox6j', 'Trouser', 1, 's', 3000, 2147483647, 'bijal@gmail.com', 'Bijal', '', '', '');
...
('aakash12', 'butwal', 'akash34@gmail.com', 98111111, '12346', 'normal'),
('admin', 'Ktm', 'dadkasjk@fafa.com', 5245, 'admin', 'admin'),
('Akash', 'Bkt', 'akash@gmail.com', 899798, 'akash123', 'normal'),
('Amar', 'bkt', 'amar@yahoo.com', 9813960138, 'amar', 'normal'),
